...
The approved content direction retains the Starter ten-logo hunt and the currently learned Is it from Germany? / Yes, it is. / No, it isn't. model. A negative response adds It's from Japan. or, for Tesla, It's from the United States. Children are not asked to spell brands or classify three countries by code. The intermediate four-question, six-question and A/B/C proposals are superseded.
